      ...
      <Layout>
        ...
        <Content style={{ display: 'flex', justifyContent: 'center' }}>
          ...
          <Typography className={styles.typography}>
            ...
            <Paragraph>
              At the heart of our company is a commitment to democratizing the music-making process and empowering
              artists to unleash their full creative potential.
            </Paragraph>
            ...
            <Paragraph>
              ...
              Our platform is user-friendy and offers a constantly expanding library of beats. Producers upload beats,
              and artists subscribe to recieve creatids each month to download the beats the need.
            </Paragraph>

            <Paragraph>
              With a user-friendly interface, a growing library of beats, and a commitment to excellence, Sweatshop
              Beats is the ideal destination for musicians and producers who want to take their craft to the next level.
            </Paragraph>
