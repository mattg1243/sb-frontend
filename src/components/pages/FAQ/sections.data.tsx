export default [
  {
    header: 'Valid Social Links',
    content: <p>Only links from these websites are valid: YouTube, Instagram, Twitter, Spotify, and LinkTree.</p>,
  },
  {
    header: 'Subscriptions, Payouts & Payments',
    content: (
      <p>
        *We use Stripe & PayPal to handle our subscription payments and payouts to users. You are required to create an
        account with Stripe or PayPal to receive payouts.*
        <br />
        <br />
        ...
        sacrificed on June 1st and they will be unable to use or regain those credits at any time after June 1st.) If a
        user is unable to make a payment at the beginning of their billing cycle, or if a payment fails, they will have
        14 days to update their billing information and make a payment before their subscription is automatically
        canceled.
        <br />
        <br />
        ...
        the period of one month. The total amount of revenue by the end of the month is then paid out to the producer in
        full through Stripe or PayPal.
        <br />
        <br />
        Payouts are initiated on the first Tuesday of each month between the hours of 9AM-5PM Pacific Time, unless the
        first Tuesday of a month lands on a federal holiday, or if other extenuating circumstances out of our control
        ...
        <br />
        <br />
        <strong>Subscription tiers, credits: </strong>
        <br />
        <strong>Basic subscription: </strong> users are entitled to 3 credits per month. <br />
        <strong>Standard subscription: </strong> users are entitled to 5 credits per month. <br />
        <strong>Premium subscription: </strong> users are entitled to 9 credits per month. <br />
      </p>
    ),
  },
  {
    header: 'How long does a license last?',
    content: (
      <p>
        Once you download a beat, it's yours forever regardless of whether or not you're subscribed. If a producer sells
        the beat you licensed exclusively after you licensed yours, you are "grandfathered" in, meaning your license
        does not suddenly expire.
      </p>
    ),
  },
  {
    header: 'What is a non-exclusive Unlimited License?',
    content: (
      <p>
        A non-exclusive license means the producer can re-sell the same license as many times as they want to other
        artists. You do not have any exclusive rights to the intellectual property you are licensing. An unlimited
